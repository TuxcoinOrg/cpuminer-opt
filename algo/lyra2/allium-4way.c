...
void allium_4way_hash( void *state, const void *input )
{
   ...
   LYRA2RE( hash0, 32, hash0, 32, hash0, 32, 1, 4, 4 );
   LYRA2RE( hash1, 32, hash1, 32, hash1, 32, 1, 4, 4 );
   LYRA2RE( hash2, 32, hash2, 32, hash2, 32, 1, 4, 4 );
   LYRA2RE( hash3, 32, hash3, 32, hash3, 32, 1, 4, 4 );
