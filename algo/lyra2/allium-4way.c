...
void allium_4way_hash( void *state, const void *input )
{
   ...
   LYRA2REV2( allium_wholeMatrix, hash0, 32, hash0, 32, hash0, 32, 1, 4, 4 );
   LYRA2REV2( allium_wholeMatrix, hash1, 32, hash1, 32, hash1, 32, 1, 4, 4 );
   LYRA2REV2( allium_wholeMatrix, hash2, 32, hash2, 32, hash2, 32, 1, 4, 4 );
   LYRA2REV2( allium_wholeMatrix, hash3, 32, hash3, 32, hash3, 32, 1, 4, 4 );
